...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-6fb30c25e28626ed"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Subgraphs; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-6fb30c25e28626ed",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-6fb30c25e28626ed",
        "url": "https://en.wikipedia.org/wiki/Pathwidth"
      }
    ],
    "statement": {
      "language": "en",
      "text": "What is the largest possible pathwidth of an n -vertex cubic graph ?",
      "version": 1
    },
    "title": "pathwidth",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "33d82040f09d473bdb02795380a87fb6a4d42ebac44499bceb77b58a9865ab7e"
}
```
